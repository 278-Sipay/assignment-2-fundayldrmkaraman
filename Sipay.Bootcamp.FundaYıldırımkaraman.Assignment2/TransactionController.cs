...
public class TransactionController : ControllerBase
{
    private static List<Transaction> _transactions = new List<Transaction>
        {
            // Parametrelere göre veri elde etmek için statik bir liste tanımlanır.
    ...
    {
        //verilen filtrelerle _transactions listesini sorgular ve uygun sonuçları döndürür. Query parametreleri kullanılarak filtreleme işlemleri gerçekleştirilir.
